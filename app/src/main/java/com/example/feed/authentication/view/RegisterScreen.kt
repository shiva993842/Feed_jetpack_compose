...
fun RegisterScreen(
    ...
    RegisterContent(
        ...
        onRegisterClick   = {
            viewModel.register(firstName, lastName, username, email, phone, password)
        },
...
fun RegisterContent(
    ...
    Box(
        ...
        Column(
            ...
            Text("Sign up to get started", fontSize = 14.sp, color = Color(0xFF999999))
            Spacer(Modifier.height(32.dp))

            FeedTextField(value = firstName, onValueChange = onFirstNameChange, label = "First name")
            Spacer(Modifier.height(14.dp))

            FeedTextField(value = lastName, onValueChange = onLastNameChange, label = "Last name")
            Spacer(Modifier.height(14.dp))

            FeedTextField(value = username, onValueChange = onUsernameChange, label = "Username")
            Spacer(Modifier.height(14.dp))

            FeedTextField(value = email, onValueChange = onEmailChange, label = "Email address",
                keyboardType = KeyboardType.Email)
            Spacer(Modifier.height(14.dp))

            FeedTextField(value = phone, onValueChange = onPhoneChange, label = "Phone number",
            ...
            Row(horizontalArrangement = Arrangement.Center, verticalAlignment = Alignment.CenterVertically) {
                Text("Already have an account? ", color = Color(0xFF999999), fontSize = 14.sp)
                Text("Login", color = Primary, fontSize = 14.sp, fontWeight = FontWeight.SemiBold,

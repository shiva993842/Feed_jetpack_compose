...
fun FeedScreen(navController: NavController) {
    ...
    val dummyPosts = remember {
        listOf(
            ...
            PostModel("18", "user18", "divya_captures", "", "https://picsum.photos/seed/225/500/500", "Golden hour hits different every time ✨ #photography",      "Bangalore, India",  listOf("user1","user4","user7","user9","user14","user18"),  134, System.currentTimeMillis() - 950000000),
            ...
            PostModel("21", "user21", "vikram_lens",    "", "https://picsum.photos/seed/261/500/500", "Every shot tells a story 📷 #streetphotography #mood",       "Hyderabad, India",  listOf("user1","user4","user7","user12","user15","user21"), 112, System.currentTimeMillis() - 1100000000),
            ...
            PostModel("24", "user24", "priya_moments",  "", "https://picsum.photos/seed/297/500/500", "Chasing light and good times 🌅📸 #photographer #sunset",    "Pune, India",       listOf("user1","user8","user13","user18","user24"),          61, System.currentTimeMillis() - 1250000000),
            PostModel("25", "user25", "aditya_vision",  "", "https://picsum.photos/seed/309/500/500", "This view though 😭🤌 absolutely breathtaking #landscape",   "Bangalore, India",  listOf("user2","user7","user12","user19","user25"),          74, System.currentTimeMillis() - 1300000000),
        )
    }
